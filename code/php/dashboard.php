...
$stmt = $conn->prepare("SELECT name, email, phone, bloodgroup, gender, birthdate, weight, state, zipcode, district, area, landmark, password, donations, received FROM registered_users WHERE email = ?");
if (!$stmt) {
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["change_password"])) {
        ...
        $stmt = $conn->prepare("UPDATE registered_users SET name=?, phone=?, bloodgroup=?, gender=?, birthdate=?, weight=?, state=?, zipcode=?, district=?, area=?, landmark=? WHERE email=?");
        if (!$stmt) {
            die("Error: " . $conn->error);
        }
      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:bloodbridge001@gmail.com" class="contact-link">bloodbridge001@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+919057574112" class="contact-link">+91-0123-456-789</a>
          </li>
        </ul>
...
<footer class="footer">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+919057574112" class="footer-link">+91-0123-456-789</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:help@example.com" class="footer-link">bloodbridge001@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          &copy; All Rights Reserved by Blood Bridge
        </p>
        <ul class="social-list">
          <li>
